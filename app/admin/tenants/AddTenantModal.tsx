...
export default function AddTenantModal({ isOpen, onClose, onSuccess }: AddTenantModalProps) {
  ...
  return (
    <>
      {/* Backdrop — covers full screen, click closes modal */}
      <div
        onClick={onClose}
        style={{
          position: "fixed",
      ...
      {/* Scroll container — sits over backdrop, handles centering + scroll */}
      <div
        style={{
          position: "fixed",
          top: 0,
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
            <div>
              ...
              <p style={{ color: "#64748b", marginTop: "0.25rem", fontSize: "0.8rem", margin: "0.25rem 0 0" }}>
                Creates a tenant and a login account.
              </p>
            </div>
            <button
              onClick={onClose}
              style={{ background: "none", border: "none", color: "#64748b", fontSize: "1.5rem", cursor: "pointer", padding: "0.25rem", lineHeight: 1 }}
            >
              &times;
            </button>
          </div>
