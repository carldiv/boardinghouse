...
export default function SettingsMenu({ logoutAction }: SettingsMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 min-w-[140px] overflow-hidden rounded-lg border border-[var(--color-surface-3)] bg-[var(--color-surface-1)] shadow-lg">
          <form
            action={logoutAction}
